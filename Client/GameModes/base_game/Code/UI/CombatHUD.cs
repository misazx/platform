...
namespace RoguelikeGame.UI
{
	...
	public partial class CombatHUD : Control, IUIScreen
	{
		...
		{
			var bgTexture = GD.Load<Texture2D>("res://GameModes/base_game/Resources/Images/Backgrounds/hive.png");
			if (bgTexture != null)
			{
		...
		private void CreatePlayerStatusBar()
		{
			...
			var playerTexture = GD.Load<Texture2D>("res://GameModes/base_game/Resources/Icons/Items/iron_sword.png");
		...
		{
			string iconPath = !string.IsNullOrEmpty(cardData.IconPath) ? cardData.IconPath : "res://GameModes/base_game/Resources/Icons/Cards/card_0.png";
			if (cardData.Type == CardType.Attack) iconPath = "res://GameModes/base_game/Resources/Icons/Cards/strike.png";
			else if (cardData.Type == CardType.Skill) iconPath = "res://GameModes/base_game/Resources/Icons/Cards/defend.png";
			else if (cardData.Type == CardType.Power) iconPath = "res://GameModes/base_game/Resources/Icons/Skills/fireball.png";
	...
	public partial class BattleCharacterSprite : Control
	{
		...
		private string GetCharacterSpritePath()
		{
			...
			{
				true => "res://GameModes/base_game/Resources/Icons/Items/iron_sword.png",
				false => _characterId.ToLower() switch
				{
					"cultist" or "jaw worm" or "jawworm" => "res://GameModes/base_game/Resources/Icons/Enemies/jawworm.png",
					"lagavulin" => "res://GameModes/base_game/Resources/Icons/Enemies/lagavulin.png",
					"theguardian" or "the guardian" or "guardian" => "res://GameModes/base_game/Resources/Icons/Enemies/theguardian.png",
					_ => "res://GameModes/base_game/Resources/Icons/Enemies/cultist.png"
				}
			};
		}
	...
	public partial class CardUI : Control
	{
		...
		{
			CardType.Attack => "res://GameModes/base_game/Resources/Icons/Cards/strike.png",
			CardType.Skill => "res://GameModes/base_game/Resources/Icons/Cards/defend.png",
			CardType.Power => "res://GameModes/base_game/Resources/Icons/Skills/fireball.png",
			_ => "res://GameModes/base_game/Resources/Icons/Cards/card_0.png"
		};
