    ...
    public partial class ShopManager : Node
    {
        ...
        private ShopItem CreateCardItem(CardData card)
        {
            ...
            return new ShopItem
            {
                ...
                IconPath = card.IconPath ?? "res://GameModes/base_game/Resources/Icons/Cards/default.png"
            };
        }
        ...
        private ShopItem CreateRelicItem(RelicData relic)
        {
            ...
            return new ShopItem
            {
                ...
                IconPath = relic.ImagePath ?? "res://GameModes/base_game/Resources/Icons/Relics/default.png"
            };
        }
        ...
        private ShopItem CreatePotionItem(PotionData potion)
        {
            ...
            return new ShopItem
            {
                ...
                IconPath = potion.ImagePath ?? "res://GameModes/base_game/Resources/Icons/Potions/default.png"
            };
        }
        ...
        private ShopItem CreateServiceItem(string serviceId, string name, int price)
        {
            return new ShopItem
            {
                ...
                IconPath = "res://GameModes/base_game/Resources/Icons/Services/default.png"
            };
        }
