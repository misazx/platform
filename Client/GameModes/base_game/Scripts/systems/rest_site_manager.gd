...
func recall_cards(player: Node) -> void:
	if player != null and player.has_method("recall_discarded_cards"):
		...
		print("[RestSiteManager] Recalled discarded cards")
