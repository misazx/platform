...
static func make_panel_bg(border_color: Color = Color(0.55, 0.45, 0.3, 0.8)) -> StyleBoxTexture:
	var style: StyleBoxTexture = _make_stylebox("panel_light", 12, 12, 12, 12, 10, 10, 8, 8)
	return style

static func make_dark_panel_bg() -> StyleBoxTexture:
	var style: StyleBoxTexture = _make_stylebox("panel_dark", 14, 14, 12, 12, 12, 12, 8, 8)
	return style

static func make_wood_panel_bg() -> StyleBoxTexture:
	var style: StyleBoxTexture = _make_stylebox("panel_wood", 6, 6, 6, 6, 4, 4, 4, 4)
	return style

static func make_medium_panel_bg() -> StyleBoxTexture:
	var style: StyleBoxTexture = _make_stylebox("panel_medium", 14, 14, 12, 12, 12, 12, 8, 8)
	return style

static func make_bar_bg_style() -> StyleBoxTexture:
	var style: StyleBoxTexture = _make_stylebox("bar_bg", 8, 8, 8, 8, 2, 2, 2, 2)
	return style

static func make_card_panel_style() -> StyleBoxTexture:
	var style: StyleBoxTexture = _make_stylebox("panel_card", 10, 10, 10, 10, 6, 6, 6, 6)
	return style
...
static func make_icon_button(icon_name: String, min_size: Vector2 = Vector2(36, 36)) -> Button:
	...
	btn.icon = get_icon(icon_name)
	btn.expand_icon = true
	var normal_style: StyleBoxTexture = _make_stylebox("btn_sq_s2_normal", 6, 6, 6, 6, 4, 4, 4, 4)
	btn.add_theme_stylebox_override("normal", normal_style)
	var hover_style: StyleBoxTexture = _make_stylebox("btn_sq_s2_hover", 6, 6, 6, 6, 4, 4, 4, 4)
	btn.add_theme_stylebox_override("hover", hover_style)
	var pressed_style: StyleBoxTexture = _make_stylebox("btn_sq_s2_pressed", 6, 6, 6, 6, 4, 4, 4, 4)
	btn.add_theme_stylebox_override("pressed", pressed_style)
