...
namespace RoguelikeGame.Systems
{
    ...
    public partial class RestSiteManager : Node
    {
        ...
        public string GetRestOptionIcon(RestOption option)
        {
            return option switch
            {
                RestOption.Heal => "res://Icons/Rest/heal.png",
                RestOption.Upgrade => "res://Icons/Rest/upgrade.png",
                RestOption.Recall => "res://Icons/Rest/recall.png",
                RestOption.Smith => "res://Icons/Rest/smith.png",
                _ => "res://Icons/Rest/default.png"
            };
        }
    }
}
